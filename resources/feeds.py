...
class RecentResourcesRss(Feed):
    title = "Recent Resources on NumberPhil"
    link = "/resource/"
    description = "Provides feed for recent resources shared on enisteinish.com"
...
class TopicRecentResourcesRss(Feed):
    ...
    def description(self, obj):
        return "feed for recent resources shared on numberphil for %s" %obj.name
