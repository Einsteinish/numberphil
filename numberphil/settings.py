...
ADMINS = (
     ('K Hong', 'contact.numberphil@gmail.com'),
)
...
ROOT_URLCONF = 'numberphil.urls'

WSGI_APPLICATION = 'numberphil.wsgi.application'
...
DISQUS_WEBSITE_SHORTNAME = 'numberphil'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'numberphil.db',                      # Or path to database file if using sqlite3.
